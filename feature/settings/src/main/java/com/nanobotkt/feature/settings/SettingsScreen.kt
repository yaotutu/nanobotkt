...
fun SettingsScreen(
    ...
    serverSwitching: Boolean = false,
    serverSwitchFeedback: String? = null,
    serverSwitchSucceeded: Boolean = false,
    onSwitchServer: (serverUrl: String, secret: String) -> Unit = { _, _ -> },
        ...
        item {
            when (section) {
                ...
                SETTINGS_SECTION_SYSTEM -> SystemPage(
                    ...
                    connectionStatus = connectionStatus,
                    gatewayEndpoint = gatewayEndpoint,
                    serverSwitching = serverSwitching,
                    serverSwitchFeedback = serverSwitchFeedback,
                    serverSwitchSucceeded = serverSwitchSucceeded,
                    onReconnect = onReconnect,
