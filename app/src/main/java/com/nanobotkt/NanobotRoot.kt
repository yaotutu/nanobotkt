    ...
    NanobotTheme(
        ...
        Surface(Modifier.fillMaxSize()) {
            when (val state = authState) {
                ...
                is AuthState.Authentication -> AuthScreen(
                    state = state,
                    initialServerUrl = appViewModel.gatewayServerUrl,
                    onSubmit = appViewModel::authenticate,
                )
...
private fun UnreachableScreen(
    ...
    Box(Modifier.fillMaxSize().padding(24.dp), contentAlignment = Alignment.Center) {
        Column(
            ...
            Text(gatewayEndpoint, color = MaterialTheme.colorScheme.onSurfaceVariant)
...
private fun ReadyRoot(
    ...
    val gatewaySwitchState by appViewModel.gatewaySwitchState.collectAsStateWithLifecycle()
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        when (destination) {
            ...
            AppDestination.SETTINGS -> SettingsScreen(
                ...
                gatewayEndpoint = appViewModel.gatewayServerUrl,
                serverSwitching = gatewaySwitchState.switching,
                serverSwitchFeedback = gatewaySwitchState.feedback,
                serverSwitchSucceeded = gatewaySwitchState.succeeded,
